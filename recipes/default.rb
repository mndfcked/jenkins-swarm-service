...
service_install_path = win_friendly_path(File.join(node['jekinsswarmservice']['install_path'], setup_zip_basename))
service_config_file = win_friendly_path(File.join("config", "wrapper.confg"))
